const EMAIL = 'gouderhaithem@gmail.com'
...
/** Social links row for the contact sections (landing page and /contact). */
export default function SocialLinks() {
  return (
    <div className="socials">
      <a href="https://github.com/gouderhaithem" target="_blank" rel="noopener noreferrer">
        <GitHubIcon />
        <span>GitHub</span>
      </a>
      <a
